...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score PassedRank[RANK_NB] = {
    S(0, 0), S(5, 17), S(11, 13), S(13, 28), S(59, 61), S(164, 170), S(266, 249)
  };

  // PassedFile[File] contains a bonus according to the file of a passed pawn
  constexpr Score PassedFile[FILE_NB] = {
	S( -1,  3), S( -5,  -4), S(-14, -11), S(-33,-12),
	S(-33,-12), S(-14, -11),  S( -5,  -4), S( -1,  3)
  };

  // PassedDanger[Rank] contains a term to weight the passed score
  constexpr int PassedDanger[RANK_NB] = { 0, 0, 0, 3, 7, 12, 20 };

  // KingProtector[knight/bishop] contains a penalty according to distance from king
  constexpr Score KingProtector[] = { S(5, 6), S(6, 7) };
  ...
  constexpr Score ThreatByKing       = S( 17, 77);
  constexpr Score ThreatByPawnPush   = S( 48, 38);
  constexpr Score ThreatByRank       = S( 16,  3);
  constexpr Score ThreatBySafePawn   = S(171,117);
  constexpr Score TrappedRook        = S( 92,  0);
  constexpr Score WeakQueen          = S( 50, 10);
  constexpr Score WeakUnopposedPawn  = S(  6, 27);
  constexpr Score weakPawn 		     = S( 10,  8);
