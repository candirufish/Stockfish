...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score ThreatByKing[] = { S(30, 76), S(20, 152) };

  // PassedRank[Rank] contains a bonus according to the rank of a passed pawn
  constexpr Score PassedRank[RANK_NB] = {
    S(0, 0), S(4, 18), S(12, 22), S(11, 26), S(65, 70), S(163, 163), S(267, 248)
  };

  // PassedFile[File] contains a bonus according to the file of a passed pawn
  constexpr Score PassedFile[FILE_NB] = {
	 S( -9, 4), S( 0, 12), S(-9, -8), S(-34,-17),
	 S(-34,-17),S(-9, -8), S( 0, 12), S( -9, 4)
  };
  ...
  constexpr Score KingProtector[] = { S(4, 6), S(6, 3), S(1, 0), S(0, 0) };
  ...
  constexpr Score ThreatByPawnPush   = S( 47, 42);
  constexpr Score ThreatByRank       = S( 16,  3);
  constexpr Score ThreatBySafePawn   = S(182,96);
  constexpr Score TrappedRook        = S( 92,  0);
  constexpr Score WeakQueen          = S( 50, 10);
  constexpr Score WeakUnopposedPawn  = S(  4, 23);
