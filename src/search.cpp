    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
          ...
          && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
      {
          ...
          else
          {
              ...
              if (   lmrDepth < 5
                  && (*contHist[0])[movedPiece][to_sq(move)] < -227 * lmrDepth * lmrDepth
                  && (*contHist[1])[movedPiece][to_sq(move)] < -158 * lmrDepth * lmrDepth
				  && (*contHist[3])[movedPiece][to_sq(move)] < -111 * lmrDepth * lmrDepth
				  && (*contHist[5])[movedPiece][to_sq(move)] < -77 * lmrDepth * lmrDepth)
                  continue;
